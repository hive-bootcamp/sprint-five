...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return float64(float64(CaloriesMeanSpeedMultiplier) * r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / float64(MInKm) * r.Duration.Hours() * float64(MinInHours)
}
...
func (s Swimming) distance() float64 {
	// вставьте ваш код ниже
	return (float64(s.CountPool) * float64(s.LengthPool)) / float64(MInKm) 
}
